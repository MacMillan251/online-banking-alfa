    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                ...
                sh 'docker build -t macmillan251/alfa-online:1 .'
            }
        }
       stage('Create Database') {
            ...
            //    sh 'docker rm cloudbank 2> /dev/null'
                ...
                sh 'docker run --detach --name=bankmysql -v /var/lib/mysql:/var/lib/mysql/mysql --env="MYSQL_ROOT_PASSWORD=${MYSQL_ROOT_PASSWORD}" -p 3306:3306 mysql:5.7.22'
                sh 'sleep 20'
        ...
        stage('Deploy and Run') {
            steps {
                ...
                sh 'docker run --detach --name=cloudbank -p 8888:8888 --link bankmysql:localhost -t macmillan251/alfa-online:1'
            }
        }
    }
}
